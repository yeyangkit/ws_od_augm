...
class _SSDResnetV1MultiscaleFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  ...
  def __init__(self,
    ...
    """
    super(_SSDResnetV1MultiscaleFeatureExtractor, self).__init__(
...
class SSDResnet50V1MultiscaleFeatureExtractor(_SSDResnetV1MultiscaleFeatureExtractor):
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDResnet50V1MultiscaleFeatureExtractor, self).__init__(
        is_training,
        depth_multiplier,
        min_depth,
        pad_to_multiple,
...
class SSDResnet50V1LightweightMultiscaleFeatureExtractor(_SSDResnetV1MultiscaleFeatureExtractor):
  """SSD Resnet50 V1 FPN feature extractor."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      override_base_feature_extractor_hyperparams: Whether to override
        ...
        `conv_hyperparams_fn`.
    """
    super(SSDResnet50V1LightweightMultiscaleFeatureExtractor, self).__init__(
        is_training,
        depth_multiplier,
        min_depth,
        pad_to_multiple,
        conv_hyperparams_fn,
        resnet_v1.resnet_v1_50_lightlightweight,
