...
flags.DEFINE_string('output', '/mrtstorage/projects/grid_map_learning/nuScenes_object_detection/nuScenes_erzeugte_gridMaps_tfrecord/with_35m_2skip_FusedLayers1007', 'Path to directory to output TFRecords.')
