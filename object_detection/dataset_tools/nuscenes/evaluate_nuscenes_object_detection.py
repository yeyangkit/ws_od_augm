            ...
            for scene in nusc.scene:
                ...
                while sample_in_scene:
                    ...
                    if not lidar_top_data['prev']:
                        lidar_top_data_prev = lidar_top_data
                    else:
                    ...
                    image_prev_stacked, det_mask_prev, _, _ = read_images(FLAGS.data, filename_prev_prefix)
                    # Inference
                    ...
                    (boxes_aligned, boxes_inclined, scores, classes, num) = sess.run(
                        ...
                        feed_dict={image_tensor: image_stacked,
                                   prev_image_tensor: image_prev_stacked
                                   })
