...
flags.DEFINE_string('data_beliefs', '/mrtstorage/projects/grid_map_learning/nuScenes_erzeugte_lidar_gridMaps/processed1007NuScenes_fused8Layers_keyFrame_trainval', 'Directory to evidential grid maps.')
...
flags.DEFINE_string('output', '/mrtstorage/projects/grid_map_learning/nuScenes_object_detection/nuScenes_erzeugte_gridMaps_tfrecord/with_35m_2skip_FusedLayers1017_1', 'Path to directory to output TFRecords.')
...
def dict_to_tf_example(labels_corners,
    ...
    return tf.train.Example(features=tf.train.Features(feature={
        ...
        'layers/ground_surface/encoded': dataset_util.bytes_feature(
            _readImage(image_dir, image_prefix, 'ground_surface_cartesian')),
        ...
        'layers/intensity_FUSED/encoded': dataset_util.bytes_feature(
            _readImage(image_dir_beliefs, image_prefix, 'intensity_FUSED_cartesian')),
