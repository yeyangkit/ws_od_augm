...
def create_kitti_labels(output_path, label_map_path, calib_dir, image_dir, graph_dir, examples):
...
def main(_):
    ...
    num_examples = 7518
    val_examples = list(range(0,num_examples))
    val_examples = list(map(str, val_examples))
    ...
    create_kitti_labels(val_output_path, label_map_path, calib_dir, image_dir, graph_dir, val_examples)
