...
def create_kitti_labels(output_path, label_map_path, calib_dir, image_dir, image_ground_dir, graph_dir, examples):
...
def main(_):
    ...
    create_kitti_labels(val_output_path, label_map_path, calib_dir, data_dir, data_ground_dir, graph_dir, test_list)
