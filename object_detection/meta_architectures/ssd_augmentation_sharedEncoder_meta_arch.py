...
#             # 'feature_maps_augm': feature_maps_augm, # todo
...
#                 augm_loss_belU = self._my_loss_L1(pred_bel_U, label_bel_U, xBiggerY=1.) * self._factor_loss_fused_bel_F / 255
...
#                 bel_o_attention_mask = 1 + label_bel_O
#
...
#                 tf.summary.image('bel_cert_mask___bel_o_mask', bel_cert_mask_img)
#
#
