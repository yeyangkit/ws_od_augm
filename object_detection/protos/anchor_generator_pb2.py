...
from object_detection.protos import multiscale_class_related_anchor_generator_pb2 as object__detection_dot_protos_dot_multiscale__class__related__anchor__generator__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  serialized_pb=_b('\n.object_detection/protos/anchor_generator.proto\x12\x17object_detection.protos\x1a<object_detection/protos/flexible_grid_anchor_generator.proto\x1a\x33object_detection/protos/grid_anchor_generator.proto\x1a\x39object_detection/protos/multiscale_anchor_generator.proto\x1a\x32object_detection/protos/ssd_anchor_generator.proto\x1aGobject_detection/protos/multiscale_class_related_anchor_generator.proto\"\xf7\x03\n\x0f\x41nchorGenerator\x12M\n\x15grid_anchor_generator\x18\x01 \x01(\x0b\x32,.object_detection.protos.GridAnchorGeneratorH\x00\x12K\n\x14ssd_anchor_generator\x18\x02 \x01(\x0b\x32+.object_detection.protos.SsdAnchorGeneratorH\x00\x12Y\n\x1bmultiscale_anchor_generator\x18\x03 \x01(\x0b\x32\x32.object_detection.protos.MultiscaleAnchorGeneratorH\x00\x12^\n\x1e\x66lexible_grid_anchor_generator\x18\x04 \x01(\x0b\x32\x34.object_detection.protos.FlexibleGridAnchorGeneratorH\x00\x12s\n)multiscale_class_related_anchor_generator\x18\x05 \x01(\x0b\x32>.object_detection.protos.MultiscaleClassRelatedAnchorGeneratorH\x00\x42\x18\n\x16\x61nchor_generator_oneof')
  ,
  dependencies=[object__detection_dot_protos_dot_flexible__grid__anchor__generator__pb2.DESCRIPTOR,object__detection_dot_protos_dot_grid__anchor__generator__pb2.DESCRIPTOR,object__detection_dot_protos_dot_multiscale__anchor__generator__pb2.DESCRIPTOR,object__detection_dot_protos_dot_ssd__anchor__generator__pb2.DESCRIPTOR,object__detection_dot_protos_dot_multiscale__class__related__anchor__generator__pb2.DESCRIPTOR,])
...
_ANCHORGENERATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='multiscale_class_related_anchor_generator', full_name='object_detection.protos.AnchorGenerator.multiscale_class_related_anchor_generator', index=4,
...
_ANCHORGENERATOR.fields_by_name['multiscale_class_related_anchor_generator'].message_type = object__detection_dot_protos_dot_multiscale__class__related__anchor__generator__pb2._MULTISCALECLASSRELATEDANCHORGENERATOR
...
_ANCHORGENERATOR.oneofs_by_name['anchor_generator_oneof'].fields.append(
  _ANCHORGENERATOR.fields_by_name['multiscale_class_related_anchor_generator'])
_ANCHORGENERATOR.fields_by_name['multiscale_class_related_anchor_generator'].containing_oneof = _ANCHORGENERATOR.oneofs_by_name['anchor_generator_oneof']
