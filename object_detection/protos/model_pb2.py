...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  serialized_pb=_b('\n#object_detection/protos/model.proto\x12\x17object_detection.protos\x1a!object_detection/protos/ssd.proto\"v\n\x0e\x44\x65tectionModel\x12+\n\x03ssd\x18\x01 \x01(\x0b\x32\x1c.object_detection.protos.SsdH\x00\x12\x16\n\x0einput_features\x18\x03 \x03(\t\x12\x16\n\x0einput_channels\x18\x04 \x03(\x05\x42\x07\n\x05model')
  ,
  dependencies=[object__detection_dot_protos_dot_ssd__pb2.DESCRIPTOR,])
...
_DETECTIONMODEL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input_features', full_name='object_detection.protos.DetectionModel.input_features', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input_channels', full_name='object_detection.protos.DetectionModel.input_channels', index=2,
