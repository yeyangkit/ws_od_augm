...
_LOSS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_uncertainty_weighting_loss', full_name='object_detection.protos.Loss.use_uncertainty_weighting_loss', index=10,
