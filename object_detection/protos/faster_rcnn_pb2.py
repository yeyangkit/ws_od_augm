...
_FASTERRCNNFEATUREEXTRACTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='channel_means', full_name='object_detection.protos.FasterRcnnFeatureExtractor.channel_means', index=3,
