...
def _provide_groundtruth(model, labels):
    ...
    model.provide_groundtruth(
        ...
        # groundtruth_boxes_mask_list=gt_boxes_mask_list,
...
def create_estimator_and_inputs_RELOAD_PRETRAINED(run_config,
                                                  hparams,
                                                  pipeline_config_path,
                                                  path_RELOAD_PRETRAINED,
                                                  config_override=None,
                                                  train_steps=None,
                                                  sample_1_of_n_eval_examples=1,
                                                  sample_1_of_n_eval_on_train_examples=1,
    ...
    model_fn = model_fn_creator(detection_model_fn, configs, hparams)
    estimator = tf.estimator.Estimator(model_fn=model_fn, config=run_config, warm_start_from=path_RELOAD_PRETRAINED)
    print("\n ==================NOW IS ESTIMATOR(RUN_CONFIG) DONE==================\n")
